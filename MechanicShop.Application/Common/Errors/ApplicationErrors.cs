...
namespace MechanicShop.Application.Common.Errors
{
    public static class ApplicationErrors
    {
        ...
        public static Error LaborOccupied =>
            Error.Conflict("ApplicationErrors.Employee.LaborOccupied", "Labor is already occupied during the requested time.");
        ...
        public static Error VehicleSchedulingConflict =>
            Error.Conflict("ApplicationErrors.Vehicle_Overlapping_WorkOrder", "The vehicle already has an overlapping WorkOrder.");

        public static Error RepairTaskNotFound =>
            Error.NotFound("RepairTask.NotFound", "RepairTask does not exist.");
        ...
        public static Error InvoiceNotFound =>
           Error.NotFound("ApplicationErrors.nvoice.NotFound", "nvoice does not exist.");

        public static Error InvalidRefreshToken =>
            Error.Validation("RefreshToken.Expiry.Invalid",
