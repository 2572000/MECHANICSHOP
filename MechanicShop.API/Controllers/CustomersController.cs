...
using MechanicShop.Contracts.Request.Customers;
...
namespace MechanicShop.API.Controllers
{
    ...
    public class CustomersController(ISender sender) : ApiController
    {
        ...
        [MapToApiVersion("1.0")]
        public async Task<IActionResult> UpdateCustomer(Guid customerId, UpdateCustomerRequest request,CancellationToken ct)
        {
            var vehicles = request.Vehicles
        ...
        {
            var result=await sender.Send(new RemoveCustomerCommand(customerId));
