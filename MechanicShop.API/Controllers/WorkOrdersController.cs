...
using MechanicShop.Contracts.Request.WorkOrder;
...
namespace MechanicShop.API.Controllers
{
    ...
    public class WorkOrdersController(ISender sender) : ApiController
    {
        ...
        [MapToApiVersion("1.0")]
        public async Task<IActionResult> GetSchedule(DateOnly? date,[FromQuery] Guid? laborId,[FromHeader(Name = "X-TimeZone")] string? tz,CancellationToken ct)
        {
