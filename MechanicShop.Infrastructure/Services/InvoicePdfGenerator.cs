...
namespace MechanicShop.Infrastructure.Services
{
    public class InvoicePdfGenerator : IInvoicePdfGenerator
    {
        ...
        private Action<QuestPDF.Infrastructure.IContainer> BuildHeader(Invoice invoice) => header =>
        {
            header.Column(col =>
            {
        ...
        private Action<QuestPDF.Infrastructure.IContainer> BuildInvoiceContent(Invoice invoice) => content =>
        {
            content.Column(col =>
            {
        ...
        private Action<QuestPDF.Infrastructure.IContainer> BuildFooter() => footer =>
        {
            footer.Row(row =>
            {
                row.RelativeItem()
